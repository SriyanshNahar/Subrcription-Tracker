          ...
          const mailOptions = {
            ...
            html: `
              <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e5e7eb; border-radius: 12px; background-color: #0A0A18; color: #FFFFFF;">
                <h2 style="color: #6C63FF; text-align: center;">📊 Trackovo Renewal Alert</h2>
                ...
                <div style="text-align: center; margin-top: 30px;">
                  <a href="https://trackovo.onrender.com" style="background-color: #6C63FF; color: white; padding: 10px 24px; border-radius: 6px; font-weight: bold; text-decoration: none;">
                    Go to My Dashboard
                  </a>
                </div>
                <div style="border-top: 1px solid #1f2937; margin-top: 30px; padding-top: 15px; text-align: center; font-size: 11px; color: #6B7280;">
                  Trackovo SaaS — Never miss a renewal again.
                </div>
              </div>
            `
          };
