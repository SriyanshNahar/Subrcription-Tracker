        ...
        <div class="flex justify-center lg:justify-end">
          <div class="glass-card rounded-3xl p-6 sm:p-8 md:p-10 w-full max-w-md border border-white/10 shadow-2xl relative overflow-hidden transition-all duration-300">
            ...
            <div class="text-center mb-8">
              ...
              <p class="text-gray-400 text-sm mt-2 font-medium">Join Trackovo today & stay optimized.</p>
            </div>
        ...
        <div class="hidden lg:flex flex-col justify-center space-y-8 pl-8">
          <div class="space-y-4">
            ...
            <h2 class="text-4xl lg:text-5xl font-extrabold tracking-tight text-white leading-tight">
              ...
              <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary to-accent">In the Trackovo Graveyard</span>
            </h2>
            <p class="text-gray-400 text-lg leading-relaxed max-w-md font-medium">
              Easily catalog canceled subscriptions inside the Trackovo Graveyard to visualize your reclaimed yearly waste and celebrate savings.
            </p>
          </div>
...
export class RegisterComponent implements OnInit {
  ...
  ngOnInit() {
    this.seo.generateTags({
      ...
      description: 'Join Trackovo today. Reclaim control of your digital subscriptions, get push alerts for upcoming renewals, and prevent hidden price hikes.'
    });
  }
